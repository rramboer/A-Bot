...
module.exports = {
    ...
    callback: async ({user}) => {
        ...
        return {
            content: "Welcome to the casino! You have nothing to your name. Claim a starting bonus with /bonus, and start earning an income with /work. I love addiction 😀! Have fun! 🥳",
        }
    }
}